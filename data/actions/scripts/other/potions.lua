local config = {
	...
	[26029] = {mana = {min = 350, max = 500}, vocations = {1, 2}, text = 'sorcerers and druids', level = 130, emptyId = 26029},
	-- health potion
	...
	[26030] = {health = {min = 650, max = 850}, vocations = {4}, text = 'knights', level = 200, emptyId = 7635},
	-- great spirit potion
	[8472] = {health = {min = 250, max = 350}, mana = {min = 100, max = 200}, vocations = {3}, text = 'paladins', level = 80, emptyId = 7635},
	-- ultimate spirit potion
	[26031] = {health = {min = 250, max = 350}, mana = {min = 250, max = 400}, vocations = {3}, text = 'paladins', level = 180, emptyId = 7635},
