...
function onUse(cid, item, fromPosition, itemEx, toPosition) 
	doPlayerAddPremiumPoints(cid, 1000)
	doPlayerSendTextMessage(cid, MESSAGE_EVENT_ADVANCE, "Se agregaron 1000 Tibia coins en tu cuenta. Ya puedes comprar cosas en el Web Shop.")
